...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('JojoSalon.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('JojoSalon.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('JojoSalon.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.menu.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('JojoSalon.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('JojoSalon.xml', function(err, result) {
      ...
      delete result.menu.section[obj.section].entree[obj.entree];
